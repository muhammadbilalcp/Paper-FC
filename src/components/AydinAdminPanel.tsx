              ...
              onClick={() => {
                if (confirm('Are you sure you want to reset ALL users money and coins to ZERO?')) {
                  ...
                  const updated = allUsers.map((u) => {
                    ...
                    return { ...u, coins: 0, points: 0, totalSalaryReceived: 0 };
                  });
                  if (onUpdateAllUsers) {
                    onUpdateAllUsers(updated);
                  } else {
                  ...
                  alert('Reset money and coins for all accounts to ZERO!');
                }
              }}
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-white/10">
              {allUsers
                ...
                .filter((u) => u.id !== 'usr-spybilal-secret' && u.username.toLowerCase() !== 'spybilal')
                .map((u) => (
